...
public class MyDBAdapter {
    ...
    private static final String DB_ROUTE_CREATE = "create table " + DB_ROUTE_TABLE + " (id integer primary key autoincrement, " + COL_ROUTE_NAME + " text not null, " + COL_STOP_1_NAME + " text not null, " + COL_STOP_1_X + " text not null, " + COL_STOP_1_Y + " text not null, " + COL_STOP_2_NAME + " text not null, " + COL_STOP_2_X + " text not null, " + COL_STOP_2_Y + " text not null, " + COL_STOP_3_NAME + " text not null, " + COL_STOP_3_X + " text not null, " + COL_STOP_3_Y + " text not null);";
    ...
    public void insertCategory(String rtname, String x, String y) {
        ContentValues contentValues = new ContentValues();
