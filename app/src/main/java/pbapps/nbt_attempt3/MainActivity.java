...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnChangeEmail, btnChangePassword, btnSendResetEmail, btnRemoveUser,
            changeEmail, changePassword, sendEmail, remove, signOut, addRouteInfo, trackBus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addRouteInfo = (Button) findViewById(R.id.add_route_button);
        ...
        addRouteInfo.setOnClickListener(new View.OnClickListener() {
            @Override
